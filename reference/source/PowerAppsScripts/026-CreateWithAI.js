...
KTR.Project = {
     ...
     * 
     * @param {*} executionContext 
     * To hide the Create with AI button from the Scripter and Librarian
     */
    displayButton: function () {
        const Role_Scripter = "3a27fcc5-cc0a-f011-bae2-000d3a2274a5";
        const Role_Librarian = "72e432d4-1b0a-f011-bae2-6045bd9d7ae1";
        const Role_CSUser = "c567cc6b-210a-f011-bae2-000d3a2274a5";
        const disallowedRoleNames = [Role_Scripter, Role_Librarian];
