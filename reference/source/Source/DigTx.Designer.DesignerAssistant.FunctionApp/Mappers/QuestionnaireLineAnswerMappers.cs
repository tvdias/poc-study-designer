...
using DigTx.Designer.FunctionApp.Helpers;

public static class QuestionnaireLineAnswerMappers
{
    ...
    public static KTR_QuestionnaireLinesAnswerList MapToEntity(
        this AnswerCreationRequest request,
        Guid questionnaireLineId)
    {
        return new KTR_QuestionnaireLinesAnswerList
        {
            ...
            KTR_AnswerType = request.Location?.ToString().GetEnum<KTR_AnswerType>(),
        };
    }
}
