...
namespace Kantar.StudyDesignerLite.Plugins
{
	...
	public partial class Team : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<Kantar.StudyDesignerLite.Plugins.TeamMobileOfflineProfileMembership> Team_TeamMobileOfflineProfileMembership_TeamId
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Kantar.StudyDesignerLite.Plugins.TeamMobileOfflineProfileMembership>("team_teammobileofflineprofilemembership_TeamId", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<Kantar.StudyDesignerLite.Plugins.TeamMobileOfflineProfileMembership>("team_teammobileofflineprofilemembership_TeamId", null, value);
			}
		}
		...
		public Kantar.StudyDesignerLite.Plugins.TeamTemplate TeamTemplate_Teams
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Kantar.StudyDesignerLite.Plugins.TeamTemplate>("teamtemplate_Teams", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<Kantar.StudyDesignerLite.Plugins.TeamTemplate>("teamtemplate_Teams", null, value);
			}
		}
