...
namespace Kantar.StudyDesignerLite.Plugins
{
    ...
    public enum SystemUser_businessrole
    {
        [System.Runtime.Serialization.EnumMemberAttribute()]
        [OptionSetMetadataAttribute("Kantar CS User", 847610000)]
        KantarCSUser = 847610000,

        [System.Runtime.Serialization.EnumMemberAttribute()]
        [OptionSetMetadataAttribute("Kantar Librarian", 847610001)]
        KantarLibrarian = 847610001,

        [System.Runtime.Serialization.EnumMemberAttribute()]
        [OptionSetMetadataAttribute("Kantar Scripter", 847610001)]
        KantarScripter = 847610002,


        [System.Runtime.Serialization.EnumMemberAttribute()]
        [OptionSetMetadataAttribute("Other", 847610003)]
        Other = 847610003,
    }
    ...
    public partial class SystemUser : Microsoft.Xrm.Sdk.Entity
    {
        ...
        public partial class Fields
        {
            ...
            public const string KTR_BusinessRole = "ktr_businessrole";
            public const string KTR_BusinessRole_label = "ktr_businessrole_label";
            public const string KTR_BusinessRoleName = "ktr_businessrolename";
        ...
        [Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ktr_businessrole")]
        public virtual KTR_KantarBusinessRole? KTR_BusinessRole
        {
            [System.Diagnostics.DebuggerNonUserCode()]
            get
            {
                return ((KTR_KantarBusinessRole?)(EntityOptionSetEnum.GetEnum(this, "ktr_businessrole")));
            }
            [System.Diagnostics.DebuggerNonUserCode()]
            set
            {
                this.SetAttributeValue("ktr_businessrole", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
            }
        }

        [Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ktr_businessrolename")]
        public string KTR_BusinessRoleName
        {
            [System.Diagnostics.DebuggerNonUserCode()]
            get
            {
                if (this.FormattedValues.Contains("ktr_businessrole"))
                {
                    return this.FormattedValues["ktr_businessrole"];
                }
                else
                {
                    return default(string);
