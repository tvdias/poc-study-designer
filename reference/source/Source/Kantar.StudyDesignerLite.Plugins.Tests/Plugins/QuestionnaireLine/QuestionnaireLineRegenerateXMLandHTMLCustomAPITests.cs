namespace Kantar.StudyDesignerLite.Plugins.Tests.Plugins.QuestionnaireLine
{
    ...
    [TestClass]
    public class QuestionnaireLineRegenerateXMLandHTMLCustomAPITests
    {
        ...
        [TestMethod]
        public void WhenQuestionnaireLineCreatedWithManagedLists_ShouldGenerateHtml_WithManagedLists()
        {
            // Arrange
            var project = new ProjectBuilder().Build();
            var question = new QuestionnaireLineBuilder(project)
