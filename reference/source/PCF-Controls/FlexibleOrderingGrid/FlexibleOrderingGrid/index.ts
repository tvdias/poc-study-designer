...
import { ListControl, IListControlProps, IListData, IListColumn } from "./extension/ListControl";
...
export class FlexibleOrderingGrid implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container: HTMLDivElement): void {
        ...
        this._props.isReadOnly = context.mode.isControlDisabled;
    ...
    private _columns = (ds: DataSet): IListColumn[] => {
        ...
        for (var column of dataSet.columns) {
            ...
            } else if (column.dataType === "SingleLine.Text" || column.dataType === "Multiple") {
                iColumn.dataType = "Text";
            }
