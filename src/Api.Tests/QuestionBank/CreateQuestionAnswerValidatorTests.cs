...
{
    private readonly CreateQuestionAnswerValidator _validator = new();

    [Fact]
    public async Task ValidQuestionAnswer_ShouldPassValidation()
    {
        // Arrange
        var request = new CreateQuestionAnswerRequest(
            "Answer Text",
            "CODE1",
            null,
            false,
    ...
    [Fact]
    public async Task NullAnswerCode_ShouldPassValidation()
    {
        // Arrange
        var request = new CreateQuestionAnswerRequest(
            "Answer Text",
