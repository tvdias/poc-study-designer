...
test.describe('Commissioning Markets Page E2E Tests', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    // Navigate to the Commissioning Markets page
    await page.goto('/commissioning-markets');
    await helpers.waitForPageLoad();
  });

  test('should complete full CRUD flow for a commissioning market', async ({ page }) => {
    // Step 1: Create a new commissioning market
    await helpers.clickNewButton();
    await helpers.waitForSidePanelTitle(/New Commissioning Market/i);
    ...
    await helpers.waitForSidePanelTitle(/Edit Commissioning Market/i);
